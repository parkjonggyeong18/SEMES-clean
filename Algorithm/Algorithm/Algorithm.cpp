// ✅ 초고속 PCB 이물질 감지 코드 (1~2초 목표) - 파싱 최적화 버전
...
#pragma omp parallel for
	...
	// ✅ 콘솔에 픽셀 + µm 단위 이물질 위치 출력
	float um_per_pixel_x = 240000.0f / cols;  // 20 µm
	float um_per_pixel_y = 77500.0f / rows;   // 19.375 µm
	...
	for (auto& b : blobs) {
		...
		cout << "이물질 위치: " << avg_x << "mm, " << avg_y << "mm" << endl;
		idx++;
